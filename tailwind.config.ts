...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        // Scale légèrement augmentée pour un rendu premium
        xs:   ["0.75rem",  { lineHeight: "1.5",  letterSpacing: "0.01em" }],
        sm:   ["0.875rem", { lineHeight: "1.6",  letterSpacing: "0em" }],
        base: ["1rem",     { lineHeight: "1.7",  letterSpacing: "-0.01em" }],
        lg:   ["1.125rem", { lineHeight: "1.65", letterSpacing: "-0.015em" }],
        xl:   ["1.25rem",  { lineHeight: "1.6",  letterSpacing: "-0.02em" }],
        "2xl":["1.5rem",   { lineHeight: "1.45", letterSpacing: "-0.025em" }],
        "3xl":["1.875rem", { lineHeight: "1.35", letterSpacing: "-0.03em" }],
        "4xl":["2.25rem",  { lineHeight: "1.25", letterSpacing: "-0.035em" }],
        "5xl":["3rem",     { lineHeight: "1.2",  letterSpacing: "-0.04em" }],
        "6xl":["3.75rem",  { lineHeight: "1.15", letterSpacing: "-0.045em" }],
        "7xl":["4.5rem",   { lineHeight: "1.12", letterSpacing: "-0.05em" }],
      },
      animation: {
