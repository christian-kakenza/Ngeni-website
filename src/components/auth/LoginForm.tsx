...
// react-hook-form + Zod + Auth.js v5 signIn("credentials")
// ============================================================
...
export function LoginForm({ callbackUrl }: LoginFormProps) {
  ...
  const defaultRedirect = `/${locale}/${locale === "fr" ? "tableau-de-bord" : "dashboard"}`;
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
      ...
      <div className="space-y-1.5">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-brand-gray/50 hover:text-brand-gray cursor-default transition-colors">
            {t("forgot_password")}
          </span>
        </div>
        <input
