...
import { ServicesNavMenu, type ServiceMenuItem } from "./ServicesNavMenu";
...
export async function Navbar({ locale }: NavbarProps) {
  ...
  // Données services pour le Mega-Menu desktop
  const lang = locale === "en" ? "en" : "fr";
  const serviceItems: ServiceMenuItem[] = SERVICES.map((s) => ({
    slug: s.slug,
    title: s[lang].title,
    badge: s[lang].badge,
    subtitle: s[lang].subtitle,
  }));
