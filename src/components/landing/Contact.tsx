          ...
          <div>
            ...
            <div className="mt-10 space-y-4">
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                {[
                  { label: fr ? "Bureau DRC" : "DRC Office", city: "Kinshasa, RDC" },
                  { label: fr ? "Bureau DRC" : "DRC Office", city: "Lubumbashi, RDC" },
                  { label: fr ? "Bureau SA" : "SA Office",  city: "Pretoria, SA" },
                ].map(({ label, city }) => (
                  <div key={city} className="flex items-start gap-3 rounded-2xl border border-brand-border bg-brand-surface/30 p-4 backdrop-blur-sm">
                    ...
                    <div>
                      <p className="text-[10px] font-semibold uppercase tracking-wider text-brand-gray/60">{label}</p>
                      <p className="mt-0.5 text-sm font-medium text-brand-white">{city}</p>
                    </div>
                  </div>
                ))}
              </div>
